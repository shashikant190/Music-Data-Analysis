...
-- We would like to throw promotional Music Festival in the city 
...
-- 4. Write a query to return the email, first name last name, and 
...
-- 5. Let's invite the artist who have written the most rock music in our dataset. Write a query that returns the Artist
...
-- 6. Find how much amount spent by each customer on artists ? Write a query to return customer name, artist name and
-- total spent
...
-- 7. Which album has been purchased the most?
...
-- 8. What is the total revenue generated by each artist?
